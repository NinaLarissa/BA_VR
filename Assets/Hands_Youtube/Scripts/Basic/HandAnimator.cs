...
public class HandAnimator : MonoBehaviour
{
    ...
    // Pull the grip, what finger need that value, give it the current value, set it to the current value
    ...
    // Check the pointer, what finger need that value, give it the current value, set it to the current value
